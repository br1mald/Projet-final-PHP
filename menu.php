...
if (file_exists(__DIR__ . "/includes/db.php")) {
    ...
    try {
        $stmt = $pdo->query(
            "SELECT c.id, c.nom, COUNT(a.id) as article_count FROM categories c LEFT JOIN articles a ON c.id = a.categorie_id GROUP BY c.id, c.nom ORDER BY c.nom",
        );
...
<nav class="site-nav">
  <ul>
    <li>
      <a href="<?= $base ?>accueil.php" class="<?= $currentPage ===
"accueil.php"
    ? "active"
    : "" ?>">Accueil</a>
    </li>
    <li>
      <a href="<?= $base ?>articles/liste_categorie.php?categorie=toutes" class="<?= $currentPage ===
    "liste_categorie.php" && ($_GET["categorie"] ?? "") === "toutes"
    ? "active"
    : "" ?>">
        Toute
    ...
    <li>
      <a href="<?= $base ?>articles/liste_categorie.php?categorie=technologie" class="<?= ($_GET[
    "categorie"
] ??
    "") ===
"technologie"
    ...
    <li>
      <a href="<?= $base ?>articles/liste_categorie.php?categorie=sport" class="<?= ($_GET[
    "categorie"
] ??
    "") ===
"sport"
    ...
    <li>
      <a href="<?= $base ?>articles/liste_categorie.php?categorie=politique" class="<?= ($_GET[
    "categorie"
] ??
    "") ===
"politique"
...
"éducation"
    ...
    <li>
      <a href="<?= $base ?>articles/liste_categorie.php?categorie=culture" class="<?= ($_GET[
    "categorie"
] ??
    "") ===
"culture"
    ...
    <li>
      <a href="<?= $base ?>articles/ajouter.php" class="<?= $currentPage ===
"ajouter.php"
    ? "active"
    : "" ?>" style="white-space: nowrap">+ Article</a>
    </li>
    <li>
      <a href="<?= $base ?>categories/liste.php" class="<?= $currentPage ===
    "liste.php" && strpos($_SERVER["PHP_SELF"] ?? "", "categories") !== false
    ? "active"
    : "" ?>">Catégories</a>
    </li>
    <?php endif; ?>
    ...
    <li>
      <a href="<?= $base ?>utilisateurs/liste.php" class="<?= $currentPage ===
    "liste.php" && strpos($_SERVER["PHP_SELF"] ?? "", "utilisateurs") !== false
    ? "active"
    : "" ?>">Utilisateurs</a>
    </li>
    <?php endif; ?>
