...
INSERT INTO articles (titre, description, contenu, categorie_id, auteur_id, date_publication, image) VALUES
(
    ...
    1, 1, '2024-01-15 09:30:00', 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800'
),
(
    ...
    2, 1, '2024-01-20 14:15:00', 'https://images.unsplash.com/photo-1431324185697-5d90c979c2ed?w=800'
),
(
    ...
    4, 1, '2024-01-25 11:00:00', 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800'
),
(
    ...
    1, 1, '2024-02-01 16:45:00', 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=800'
),
(
    ...
    2, 1, '2024-02-05 10:30:00', 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=800'
),
(
    ...
    3, 1, '2024-02-10 13:20:00', 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800'
),
(
    ...
    5, 1, '2024-02-15 18:00:00', 'https://images.unsplash.com/photo-1503095396548-807759245b35?w=800'
),
(
    ...
    1, 2, '2024-02-20 09:15:00', 'https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800'
),
(
    ...
    2, 2, '2024-02-25 20:30:00', 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=800'
),
(
    ...
    3, 2, '2024-03-01 12:00:00', 'https://images.unsplash.com/photo-1586953208448-b95a79798f07?w=800'
),
(
    ...
    4, 2, '2024-03-05 15:45:00', 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=800'
),
(
    ...
    5, 2, '2024-03-10 19:30:00', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800'
),
(
    ...
    1, 1, '2024-03-15 08:00:00', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800'
);
